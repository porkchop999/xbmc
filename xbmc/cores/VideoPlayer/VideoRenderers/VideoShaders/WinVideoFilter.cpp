...
void CYUV2RGBShader::SetShaderParameters(CRenderBuffer* videoBuffer)
{
  ...
  m_effect.SetMatrix("g_ColorMatrix", reinterpret_cast<float*>(yuvMat.ToRaw()));
  ...
  if (m_colorConversion)
  {
    ...
    m_effect.SetMatrix("g_primMat", reinterpret_cast<float*>(primMat.ToRaw));
